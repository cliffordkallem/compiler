...
public static void delete()
{
	...
	public static void writer(int a[][]) {
		for (int i = 0; i < a.length; i++) {
	...
	public static void writer(String out) {

		fout.print(out);

	}
	public static void writerln(String out) {

		fout.println(out);

	}
	public static void writer(int out) {
	...
	public static void writerln(String type, String token, int line, int place) {
